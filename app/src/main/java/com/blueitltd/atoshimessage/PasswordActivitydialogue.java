...
public class PasswordActivitydialogue extends AppCompatActivity {
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_password_dialogue);
...
//        Log.e("value",String.valueOf(Character.toChars(Integer.parseInt("অ", 16))));
        ...
        iv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(PasswordActivitydialogue.this, "clicked", Toast.LENGTH_SHORT).show();
            }
        });
                    ...
                    if (cursor.moveToFirst()){
                        do{
                            ...
                            if(data.equals(md5(passwordstr))){
                                ...
                                startActivity(new Intent(PasswordActivitydialogue.this,MainActivity.class));
                                finish();
        ...
        if(fingerprintManager!=null){
            if(!fingerprintManager.isHardwareDetected()){
                ...
                if (cipherInit()){
                    ...
                    FingerPrintHandler fingerprintHandler = new FingerPrintHandler(this,name,number);
